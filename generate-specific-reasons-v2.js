...
const genericPatterns = [
  '这是意大利值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是法国值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是荷兰值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是比利时值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是西班牙值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是瑞士值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是梵蒂冈值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是德国值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是爱尔兰值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是摩纳哥值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。',
  '这是卢森堡值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。'
];
...
genericPatterns.forEach(pattern => {
  ...
  while ((match = regex.exec(content)) !== null) {
    const country = pattern.match(/这是(.+?)值得一游的重要景点/)?.[1] || '未知';
...
Object.entries(specificReasons).forEach(([name, reason]) => {
  ...
  replacementScript += `  /'${escapedName}': '这是[^']*值得一游的重要景点，拥有独特的魅力和丰富的文化内涵，是深入了解当地历史文化的好去处。'/g,\n`;
